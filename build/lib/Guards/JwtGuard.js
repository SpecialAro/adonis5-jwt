...
class JWTGuard extends Base_1.BaseGuard {
    ...
    async check() {
        try {
             ...
             */
            if (!(error instanceof JwtAuthenticationException_1.default) && !(error instanceof jose_2.errors.JWTExpired)) {
                throw error;
            }
     ...
     */
    async generateTokenForPersistance(expiresIn, refreshTokenExpiresIn, payload = {}, rememberMe = false) {
        if (!expiresIn) {
